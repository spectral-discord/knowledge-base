...
- Spectrum
	...
	- This is similar to the concept of *timbre*, which is a term that has been used for various purposes in psychoacoustics and music theory. Spectrum has also been used (Sethares et al.) in a way similar to its usage in TSON
